...
typedef enum {
   ...
   MENU_KEYBOARD_HOST_LAYOUT,
   MENU_KEYBOARD_RELOAD,
   MENU_KEYBOARD_MONITOR,
   MENU_MOUSE_TYPE,
   MENU_MOUSE_SENSITIVITY,
   MENU_MOUSE_MONITOR,
   ...
   MENU_SYSTEM_DEVELOPER_STATUS,
   MENU_SYSTEM_DEVELOPER_PASSWORD,
   MENU_SYSTEM_DEVELOPER_BUFFER_SIZE,
   MENU_SYSTEM_DEVELOPER_APPLY,
   MENU_CONFIRM_SYSTEM_DEVELOPER,

   MENU_OVERCLOCK_ARM_FREQ,
   MENU_OVERCLOCK_VOLTAGE_DELTA,
   MENU_OVERCLOCK_TEMP_LIMIT,
   MENU_OVERCLOCK_CORE_FREQ,
   MENU_OVERCLOCK_V3D_FREQ,
   MENU_OVERCLOCK_RESTORE_DEFAULTS,
   MENU_OVERCLOCK_APPLY,
   MENU_OVERCLOCK_CONFIG_ERROR,
